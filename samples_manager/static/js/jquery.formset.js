 ...
 */
console.log("loaded formsets.js");
;(function($) {
    $.fn.formset = function(opts)
    {
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            // Modified for IDM. Added line below
            ...
            */
            showDeleteLinks = function() {
                // Modified for IDM. Modified condition and created numDeletedFields.
                /*var condition = (minForms.length == 0 || // For Django versions pre 1.7
                    (minForms.val() == '' || 
                    (totalForms.val() - minForms.val() > 0)));*/
                var numDeletedFields = $("." + options.formCssClass + " input:hidden[id $= '-DELETE']").filter("[value='on']").length;
                var condition = (minForms.length == 0 ||
                    (minForms.val() == '' || 
                    (totalForms.val() - minForms.val() - numDeletedFields > 0)));
                return condition
            },
            ...
            insertDeleteLink = function(row) {
                ...
                row.find('a.' + delCssSelector).click(function() {
                    ...
                    if (del.length) {
                        ...
                        /*
                        Modified for IDM. Modified content inside if(del.length) statement.
                        ...
                        */
                        ...
                        var index = siblings.index(row);
                        var condition = (index >= initialForms.val() && numSiblings > minForms.val())
                        if (condition){
                            row.remove();
                        } else {
                            del.val('on');
        ...
        $$.each(function(i) {
            ...
            if (hasChildElements(row)) {
                ...
                // Modified for IDM.
                //var condition = row.is(':visible'); 
                var condition = (row.is(':visible') || !row[0].hidden);
        ...
        if ($$.length) {
            ...
            if (options.formTemplate) {
                ...
                // Modified for IDM added the next two lines
                template[0].className = template[0].className.replace(' has-error', '');
                template.find('span').remove();
                // Modified for IDM. Commented line below.
