console.log('loaded fluence_factors.js');
$(function () {
    /**
    ...
    */
    var loadForm = function () {
        ...
        var modalID = '#modal-fluence-factor';
        var type = 'get';
        var dataType = 'json';
    ...
    */
    ...
    var eventListeres = [
        // Create, update, clone and delete forms
        {
            "selector": "body", 
            "event": "click", 
            "childSelector": ".js-load-fluence-factor-form", 
            "handler": loadForm
        },
        {
            "selector": "body", 
            "event": "submit", 
            "childSelector": ".js-submit-fluence-factor-form", 
            "handler": saveForm
        },
    ];
