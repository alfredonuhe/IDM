...
$(function () {
    /**
    * Handler for display user form button.
    */
    ...
    /**
    * Handler for submit user form button.
    */
    ...
    var eventListeres = [
        // Create, update, clone and delete forms
        {
            "selector": "body", 
            "event": "click", 
            "childSelector": ".js-load-user-form", 
            "handler": loadForm
        },
        {
            "selector": "body", 
            "event": "submit", 
            "childSelector": ".js-submit-user-form", 
            "handler": saveForm
        }
    ];
